...
└── store
    ...
    └── modules
        ├── cart.js       # 购物车模块
        └── products.js   # 产品模块
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function h(_,b){const i=r("ExternalLinkIcon");return s(),t("div",null,[c,u,n("p",null,[e("Vuex 也集成到 Vue 的官方调试工具 "),n("a",v,[e("devtools extension (opens new window)"),l(i)]),e("，提供了诸如零配置的 time-travel 调试、状态快照导入导出等高级调试功能。")]),m])}const x=a(o,[["render",h],["__file","10.html.vue"]]);export{x as default};
