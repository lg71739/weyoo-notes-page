import{_ as e,o as i,c as a,f as n}from"./app-f7f3c601.js";const s={},d=n(`<h1 id="nginx的安装与配置" tabindex="-1"><a class="header-anchor" href="#nginx的安装与配置" aria-hidden="true">#</a> Nginx的安装与配置</h1><p>本文主要讲解通过yum在线安装Nginx的方法</p><h2 id="添加yum源" tabindex="-1"><a class="header-anchor" href="#添加yum源" aria-hidden="true">#</a> 添加Yum源</h2><h3 id="配置官方源" tabindex="-1"><a class="header-anchor" href="#配置官方源" aria-hidden="true">#</a> 配置官方源</h3><p>执行如下命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">rpm</span> <span class="token parameter variable">-ivh</span> http://nginx.org/packages/centos/7/noarch/RPMS/nginx-release-centos-7-0.el7.ngx.noarch.rpm
