import{_ as l,U as c,V as r,W as a,a3 as s,a2 as e,a4 as i,I as t}from"./framework-0db41e67.js";const d={},o=i('<h1 id="kibana的安装与配置" tabindex="-1"><a class="header-anchor" href="#kibana的安装与配置" aria-hidden="true">#</a> Kibana的安装与配置</h1><h2 id="下载与配置" tabindex="-1"><a class="header-anchor" href="#下载与配置" aria-hidden="true">#</a> 下载与配置</h2><h3 id="下载" tabindex="-1"><a class="header-anchor" href="#下载" aria-hidden="true">#</a> 下载</h3><p>注意选择对应版本下载，本项目使用的版本为7.6.2</p>',4),v=a("p",null,"下载路径:",-1),u={href:"http://elastic.co/cn/downloads/kibana",target:"_blank",rel:"noopener noreferrer"},p={href:"https://elasticsearch.cn/download/",target:"_blank",rel:"noopener noreferrer"},b=i(`<h3 id="解压缩" tabindex="-1"><a class="header-anchor" href="#解压缩" aria-hidden="true">#</a> 解压缩</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> /home/elk/kibana
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30);function m(h,k){const n=t("ExternalLinkIcon");return c(),r("div",null,[o,a("blockquote",null,[v,a("p",null,[s("官网:"),a("a",u,[s("http://elastic.co/cn/downloads/kibana"),e(n)])]),a("p",null,[s("非官方:"),a("a",p,[s("https://elasticsearch.cn/download/"),e(n)])])]),b])}const f=l(d,[["render",m],["__file","50-1692945694619.html.vue"]]);export{f as default};
