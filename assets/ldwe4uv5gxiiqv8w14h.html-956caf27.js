import{_ as n,o as s,c as a,f as t}from"./app-40f6e90d.js";const e={},p=t(`<h2 id="query参数" tabindex="-1"><a class="header-anchor" href="#query参数" aria-hidden="true">#</a> Query参数</h2><h3 id="传递参数" tabindex="-1"><a class="header-anchor" href="#传递参数" aria-hidden="true">#</a> 传递参数</h3><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token comment">&lt;!-- 跳转并携带query参数，to的字符串写法 --&gt;</span>
