import{_ as n,Z as s,$ as a,a4 as e}from"./framework-4a2165a0.js";const t={},p=e(`<h2 id="安装-vuex" tabindex="-1"><a class="header-anchor" href="#安装-vuex" aria-hidden="true">#</a> 安装 Vuex</h2><p><code>npm install vuex --save</code></p><h2 id="创建文件" tabindex="-1"><a class="header-anchor" href="#创建文件" aria-hidden="true">#</a> 创建文件</h2><p><code>src/store/index.js</code> ：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> Vue <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
